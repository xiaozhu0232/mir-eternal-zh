...
{
	public override MIME_h_ContentType DefaultBodyPartContentType => new MIME_h_ContentType("message/rfc822");

	public MIME_b_MultipartDigest(MIME_h_ContentType contentType)
		: base(contentType)
	{
