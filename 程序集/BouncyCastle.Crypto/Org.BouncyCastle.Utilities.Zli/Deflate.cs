...
public sealed class Deflate
{
	...
	internal void scan_tree(short[] tree, int max_code)
	{
		...
		for (int i = 0; i <= max_code; i++)
		{
			...
			if (num3 < num5)
			{
				...
				int num7 = num6 * 2;
				nint num8 = num7;
				array2[num7] = (short)(array[num8] + (short)num3);
			}
			else if (num6 != 0)
			{
				short[] array;
				if (num6 != num)
				{
					short[] array3 = (array = bl_tree);
					int num9 = num6 * 2;
					nint num8 = num9;
					array3[num9] = (short)(array[num8] + 1);
				}
	...
	internal bool _tr_tally(int dist, int lc)
	{
		...
		else
		{
			...
			num2 = num4;
			array4[num4] = (short)(array[num2] + 1);
		}
		if ((last_lit & 0x1FFF) == 0 && level > 2)
		{
			...
			for (int i = 0; i < 30; i++)
			{
				num5 += (int)(dyn_dtree[i * 2] * (5L + (long)Tree.extra_dbits[i]));
			}
			num5 >>= 3;
